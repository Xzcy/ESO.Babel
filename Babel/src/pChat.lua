...
BB.AddonList["pChat"] = function() if not pChat then return false end
  ...
  SafeAddString(PCHAT_modifierKeyForNewChatTab, "SHIFT+左键 新建选项卡")
	SafeAddString(PCHAT_modifierKeyForNewChatTab_TT, "启用后，需要按住SHIFT键时，左键 \"+\" 图标才可以新建选项卡，以防止误触")
	SafeAddString(PCHAT_modifierKeyForNewChatTabButtonTT, "[pChat] SHIFT + 左键 新建选项卡")
